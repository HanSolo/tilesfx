...
public class Tile extends Control {
    public enum SkinType { SMOOTHED_CHART("ChartTileSkin"), BAR_CHART("BarChartTileSkin"),
                           ...
                           CIRCULAR_PROGRESS_NUMBER("CircularProgressNumberTileSkin"),
    ...
    @Override protected Skin createDefaultSkin() {
        switch (skinType) {
            ...
            case CIRCULAR_PROGRESS_NUMBER : return new CircularProgressNumberTileSkin(Tile.this);
    ...
    public void setSkinType(final SkinType SKIN_TYPE) {
        skinType = SKIN_TYPE;
        switch (SKIN_TYPE) {
            case SMOOTHED_CHART           -> setSkin(new SmoothedChartTileSkin(Tile.this));
            case BAR_CHART                -> setSkin(new BarChartTileSkin(Tile.this));
            case CLOCK                    -> setSkin(new ClockTileSkin(Tile.this));
            case GAUGE                    -> setSkin(new GaugeTileSkin(Tile.this));
            case GAUGE2                   -> setSkin(new Gauge2TileSkin(Tile.this));
            case HIGH_LOW                 -> setSkin(new HighLowTileSkin(Tile.this));
            case PERCENTAGE               -> setSkin(new PercentageTileSkin(Tile.this));
            case PLUS_MINUS               -> setSkin(new PlusMinusTileSkin(Tile.this));
            case SLIDER                   -> setSkin(new SliderTileSkin(Tile.this));
            case SPARK_LINE               -> setSkin(new SparkLineTileSkin(Tile.this));
            case SWITCH                   -> setSkin(new SwitchTileSkin(Tile.this));
            case WORLDMAP                 -> setSkin(new WorldMapTileSkin(Tile.this));
            case TIMER_CONTROL            -> setSkin(new TimerControlTileSkin(Tile.this));
            case NUMBER                   -> setSkin(new NumberTileSkin(Tile.this));
            case TEXT                     -> setSkin(new TextTileSkin(Tile.this));
            case TIME                     -> setSkin(new TimeTileSkin(Tile.this));
            case CUSTOM                   -> setSkin(new CustomTileSkin(Tile.this));
            case CUSTOM_SCROLLABLE        -> setSkin(new CustomScrollableTileSkin(Tile.this));
            case LEADER_BOARD             -> setSkin(new LeaderBoardTileSkin(Tile.this));
            case RADIAL_CHART             -> setSkin(new RadialChartTileSkin(Tile.this));
            case DONUT_CHART              -> setSkin(new DonutChartTileSkin(Tile.this));
            case CIRCULAR_PROGRESS        -> setSkin(new CircularProgressTileSkin(Tile.this));
            case CIRCULAR_PROGRESS_NUMBER -> setSkin(new CircularProgressNumberTileSkin(Tile.this));
            case STOCK                    -> setSkin(new StockTileSkin(Tile.this));
            case GAUGE_SPARK_LINE         -> setSkin(new GaugeSparkLineTileSkin(Tile.this));
            case SMOOTH_AREA_CHART        -> setSkin(new SmoothAreaChartTileSkin(Tile.this));
            case RADAR_CHART              -> setSkin(new RadarChartTileSkin(Tile.this));
            case RADAR_NODE_CHART         -> setSkin(new RadarNodeChartTileSkin(Tile.this));
            case COUNTRY                  -> setSkin(new CountryTileSkin(Tile.this));
            case CHARACTER                -> setSkin(new CharacterTileSkin(Tile.this));
            case FLIP                     -> setSkin(new FlipTileSkin(Tile.this));
            case SWITCH_SLIDER            -> setSkin(new SwitchSliderTileSkin(Tile.this));
            case DATE                     -> setSkin(new DateTileSkin(Tile.this));
            case CALENDAR                 -> setSkin(new CalendarTileSkin(Tile.this));
            case SUNBURST                 -> setSkin(new SunburstChartTileSkin(Tile.this));
            case MATRIX                   -> setSkin(new MatrixTileSkin(Tile.this));
            case MATRIX_ICON              -> setSkin(new MatrixIconTileSkin(Tile.this));
            case RADIAL_PERCENTAGE        -> setSkin(new RadialPercentageTileSkin(Tile.this));
            case STATUS                   -> setSkin(new StatusTileSkin(Tile.this));
            case BAR_GAUGE                -> setSkin(new BarGaugeTileSkin(Tile.this));
            case IMAGE                    -> setSkin(new ImageTileSkin(Tile.this));
            case IMAGE_COUNTER            -> setSkin(new ImageCounterTileSkin(Tile.this));
            case TIMELINE                 -> setSkin(new TimelineTileSkin(Tile.this));
            case CLUSTER_MONITOR          -> setSkin(new ClusterMonitorTileSkin(Tile.this));
            case LED                      -> setSkin(new LedTileSkin(Tile.this));
            case COUNTDOWN_TIMER          -> setSkin(new CountdownTimerTileSkin(Tile.this));
            case CYCLE_STEP               -> setSkin(new CycleStepTileSkin(Tile.this));
            case COLOR                    -> setSkin(new ColorTileSkin(Tile.this));
            case FLUID                    -> setSkin(new FluidTileSkin(Tile.this));
            case FIRE_SMOKE               -> setSkin(new FireSmokeTileSkin(Tile.this));
            case TURNOVER                 -> setSkin(new TurnoverTileSkin(Tile.this));
            case RADIAL_DISTRIBUTION      -> setSkin(new RadialDistributionTileSkin(Tile.this));
            case SPINNER                  -> setSkin(new SpinnerTileSkin(Tile.this));
            case CENTER_TEXT              -> setSkin(new CenterTextTileSkin(Tile.this));
            default                       -> setSkin(new TileSkin(Tile.this));
        }
        fireTileEvt(RESIZE_EVENT);
