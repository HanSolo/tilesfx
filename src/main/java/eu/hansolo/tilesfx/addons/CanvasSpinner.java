...
public class CanvasSpinner extends Region implements Spinner {
    ...
    private final          SpinnerEvent                           VALUE_CHANGED_EVENT = new SpinnerEvent(CanvasSpinner.this, SpinnerEventType.VALUE_CHANGED);
    private final          SpinnerEvent                           ZERO_PASSED_EVENT   = new SpinnerEvent(CanvasSpinner.this, SpinnerEventType.ZERO_PASSED);
        ...
        if (width > 0 && height > 0) {
            ...
            switch(spinnerType) {
                case ALPHABETIC:
                    ...
                    break;
                case SIGNS:
                    columnHeight  = digitHeight * 1;
                    verticalSpace = columnHeight / 2;
                    break;
                case NUMERIC_0_9:
                case NUMERIC_0_5:
                case NUMERIC_0_3:
