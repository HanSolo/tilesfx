    ...
    public final Tile build() {
        ...
        properties.forEach((key, property) -> {
            switch (key) {
                ...
                case "prefWidth"                         -> TILE.setPrefWidth(((DoubleProperty) property).get());
                case "prefHeight"                        -> TILE.setPrefHeight(((DoubleProperty) property).get());
                case "minWidth"                          -> TILE.setMinWidth(((DoubleProperty) property).get());
                case "minHeight"                         -> TILE.setMinHeight(((DoubleProperty) property).get());
                case "maxWidth"                          -> TILE.setMaxWidth(((DoubleProperty) property).get());
                case "maxHeight"                         -> TILE.setMaxHeight(((DoubleProperty) property).get());
                case "scaleX"                            -> TILE.setScaleX(((DoubleProperty) property).get());
                case "scaleY"                            -> TILE.setScaleY(((DoubleProperty) property).get());
                case "layoutX"                           -> TILE.setLayoutX(((DoubleProperty) property).get());
                case "layoutY"                           -> TILE.setLayoutY(((DoubleProperty) property).get());
                case "translateX"                        -> TILE.setTranslateX(((DoubleProperty) property).get());
                case "translateY"                        -> TILE.setTranslateY(((DoubleProperty) property).get());
                case "padding"                           -> TILE.setPadding(((ObjectProperty<Insets>) property).get());
                case "styleClass"                        -> {
                    TILE.getStyleClass().setAll("tile");
                    TILE.getStyleClass().addAll(((ObjectProperty<String[]>) property).get());
                }
                case "autoScale"                         -> TILE.setAutoScale(((BooleanProperty) property).get());
                case "value"                             -> TILE.setValue(((DoubleProperty) property).get());
                case "decimals"                          -> TILE.setDecimals(((IntegerProperty) property).get());
                case "shortenNumbers"                    -> TILE.setShortenNumbers(((BooleanProperty) property).get());
                case "tickLabelDecimals"                 -> TILE.setTickLabelDecimals(((IntegerProperty) property).get());
                case "tickLabelsXVisible"                -> TILE.setTickLabelsXVisible(((BooleanProperty) property).get());
                case "tickLabelsYVisible"                -> TILE.setTickLabelsYVisible(((BooleanProperty) property).get());
                case "minValueVisible"                   -> TILE.setMinValueVisible(((BooleanProperty) property).get());
                case "maxValueVisible"                   -> TILE.setMaxValueVisible(((BooleanProperty) property).get());
                case "title"                             -> TILE.setTitle(((StringProperty) property).get());
                case "titleAlignment"                    -> TILE.setTitleAlignment(((ObjectProperty<TextAlignment>) property).get());
                case "description"                       -> TILE.setDescription(((StringProperty) property).get());
                case "descriptionAlignment"              -> TILE.setDescriptionAlignment(((ObjectProperty<Pos>) property).get());
                case "unit"                              -> TILE.setUnit(((StringProperty) property).get());
                case "thumbColor"                        -> TILE.setThumbColor(((ObjectProperty<Color>) property).get());
                case "flatUI"                            -> TILE.setFlatUI(((BooleanProperty) property).get());
                case "selected"                          -> TILE.setActive(((BooleanProperty) property).get());
                case "averagingEnabled"                  -> TILE.setAveragingEnabled(((BooleanProperty) property).get());
                case "averagingPeriod"                   -> TILE.setAveragingPeriod(((IntegerProperty) property).get());
                case "timePeriod"                        -> TILE.setTimePeriod(((ObjectProperty<java.time.Duration>) property).get());
                case "maxTimePeriod"                     -> TILE.setMaxTimePeriod(((ObjectProperty<java.time.Duration>) property).get());
                case "timePeriodResolution"              -> TILE.setTimePeriodResolution(((ObjectProperty<TimeUnit>) property).get());
                case "fixedYScale"                       -> TILE.setFixedYScale(((BooleanProperty) property).get());
                case "startFromZero"                     -> TILE.setStartFromZero(((BooleanProperty) property).get());
                case "returnToZero"                      -> TILE.setReturnToZero(((BooleanProperty) property).get());
                case "minMeasuredValueVisible"           -> TILE.setMinMeasuredValueVisible(((BooleanProperty) property).get());
                case "maxMeasuredValueVisible"           -> TILE.setMaxMeasuredValueVisible(((BooleanProperty) property).get());
                case "oldValueVisible"                   -> TILE.setOldValueVisible(((BooleanProperty) property).get());
                case "valueVisible"                      -> TILE.setValueVisible(((BooleanProperty) property).get());
                case "foregroundColor"                   -> TILE.setForegroundColor(((ObjectProperty<Color>) property).get());
                case "backgroundColor"                   -> TILE.setBackgroundColor(((ObjectProperty<Color>) property).get());
                case "borderColor"                       -> TILE.setBorderColor(((ObjectProperty<Color>) property).get());
                case "borderWidth"                       -> TILE.setBorderWidth(((DoubleProperty) property).get());
                case "knobColor"                         -> TILE.setKnobColor(((ObjectProperty<Color>) property).get());
                case "animated"                          -> TILE.setAnimated(((BooleanProperty) property).get());
                case "animationDuration"                 -> TILE.setAnimationDuration(((LongProperty) property).get());
                case "pauseDuration"                     -> TILE.setPauseDuration(((LongProperty) property).get());
                case "startAngle"                        -> TILE.setStartAngle(((DoubleProperty) property).get());
                case "angleRange"                        -> TILE.setAngleRange(((DoubleProperty) property).get());
                case "needleColor"                       -> TILE.setNeedleColor(((ObjectProperty<Color>) property).get());
                case "barColor"                          -> TILE.setBarColor(((ObjectProperty<Color>) property).get());
                case "barBackgroundColor"                -> TILE.setBarBackgroundColor(((ObjectProperty<Color>) property).get());
                case "locale"                            -> TILE.setLocale(((ObjectProperty<Locale>) property).get());
                case "numberFormat"                      -> TILE.setNumberFormat(((ObjectProperty<NumberFormat>) property).get());
                case "shadowsEnabled"                    -> TILE.setShadowsEnabled(((BooleanProperty) property).get());
                case "style"                             -> TILE.setStyle(((StringProperty) property).get());
                case "innerShadowEnabled"                -> TILE.setInnerShadowEnabled(((BooleanProperty) property).get());
                case "thresholdVisible"                  -> TILE.setThresholdVisible(((BooleanProperty) property).get());
                case "lowerThresholdVisible"             -> TILE.setLowerThresholdVisible(((BooleanProperty) property).get());
                case "averageVisible"                    -> TILE.setAverageVisible(((BooleanProperty) property).get());
                case "sectionsVisible"                   -> TILE.setSectionsVisible(((BooleanProperty) property).get());
                case "sectionsAlwaysVisible"             -> TILE.setSectionsAlwaysVisible(((BooleanProperty) property).get());
                case "sectionTextVisible"                -> TILE.setSectionTextVisible(((BooleanProperty) property).get());
                case "sectionIconsVisible"               -> TILE.setSectionIconsVisible(((BooleanProperty) property).get());
                case "highlightSections"                 -> TILE.setHighlightSections(((BooleanProperty) property).get());
                case "titleColor"                        -> TILE.setTitleColor(((ObjectProperty<Color>) property).get());
                case "descriptionColor"                  -> TILE.setDescriptionColor(((ObjectProperty<Color>) property).get());
                case "unitColor"                         -> TILE.setUnitColor(((ObjectProperty<Color>) property).get());
                case "valueColor"                        -> TILE.setValueColor(((ObjectProperty<Color>) property).get());
                case "thresholdColor"                    -> TILE.setThresholdColor(((ObjectProperty<Color>) property).get());
                case "lowerThresholdColor"               -> TILE.setLowerThresholdColor(((ObjectProperty<Color>) property).get());
                case "orientation"                       -> TILE.setOrientation(((ObjectProperty<Orientation>) property).get());
                case "checkSectionsForValue"             -> TILE.setCheckSectionsForValue(((BooleanProperty) property).get());
                case "checkThreshold"                    -> TILE.setCheckThreshold(((BooleanProperty) property).get());
                case "checkLowerThreshold"               -> TILE.setCheckLowerThreshold(((BooleanProperty) property).get());
                case "onValueChanged"                    -> TILE.currentValueProperty().addListener(((ObjectProperty<InvalidationListener>) property).get());
                case "keepAspect"                        -> TILE.setKeepAspect(((BooleanProperty) property).get());
                case "threshold"                         -> TILE.setThreshold(((DoubleProperty) property).get());
                case "lowerThreshold"                    -> TILE.setLowerThreshold(((DoubleProperty) property).get());
                case "referenceValue"                    -> TILE.setReferenceValue(((DoubleProperty) property).get());
                case "autoReferenceValue"                -> TILE.setAutoReferenceValue(((BooleanProperty) property).get());
                case "customFontEnabled"                 -> TILE.setCustomFontEnabled(((BooleanProperty) property).get());
                case "customFont"                        -> TILE.setCustomFont(((ObjectProperty<Font>) property).get());
                case "customDecimalFormatEnabled"        -> TILE.setCustomDecimalFormatEnabled(((BooleanProperty) property).get());
                case "customDecimalFormat"               -> TILE.setCustomDecimalFormat(((ObjectProperty<DecimalFormat>) property).get());
                case "alertMessage"                      -> TILE.setAlertMessage(((StringProperty) property).get());
                case "smoothing"                         -> TILE.setSmoothing(((BooleanProperty) property).get());
                case "time"                              -> TILE.setTime(((ObjectProperty<ZonedDateTime>) property).get());
                case "text"                              -> TILE.setText(((StringProperty) property).get());
                case "textAlignment"                     -> TILE.setTextAlignment(((ObjectProperty<TextAlignment>) property).get());
                case "discreteSeconds"                   -> TILE.setDiscreteSeconds(((BooleanProperty) property).get());
                case "discreteMinutes"                   -> TILE.setDiscreteMinutes(((BooleanProperty) property).get());
                case "discreteHours"                     -> TILE.setDiscreteHours(((BooleanProperty) property).get());
                case "secondsVisible"                    -> TILE.setSecondsVisible(((BooleanProperty) property).get());
                case "textVisible"                       -> TILE.setTextVisible(((BooleanProperty) property).get());
                case "dateVisible"                       -> TILE.setDateVisible(((BooleanProperty) property).get());
                case "percentageVisible"                 -> TILE.setPercentageVisible(((BooleanProperty) property).get());
                case "textColor"                         -> TILE.setTextColor(((ObjectProperty<Color>) property).get());
                case "dateColor"                         -> TILE.setDateColor(((ObjectProperty<Color>) property).get());
                case "hourTickMarkColor"                 -> TILE.setHourTickMarkColor(((ObjectProperty<Color>) property).get());
                case "minuteTickMarkColor"               -> TILE.setMinuteTickMarkColor(((ObjectProperty<Color>) property).get());
                case "alarmColor"                        -> TILE.setAlarmColor(((ObjectProperty<Color>) property).get());
                case "tickLabelColor"                    -> TILE.setTickLabelColor(((ObjectProperty<Color>) property).get());
                case "tickMarkColor"                     -> TILE.setTickMarkColor(((ObjectProperty<Color>) property).get());
                case "hourTickMarksVisible"              -> TILE.setHourTickMarksVisible(((BooleanProperty) property).get());
                case "minuteTickMarksVisible"            -> TILE.setMinuteTickMarksVisible(((BooleanProperty) property).get());
                case "hourColor"                         -> TILE.setHourColor(((ObjectProperty<Color>) property).get());
                case "minuteColor"                       -> TILE.setMinuteColor(((ObjectProperty<Color>) property).get());
                case "secondColor"                       -> TILE.setSecondColor(((ObjectProperty<Color>) property).get());
                case "onAlarm"                           -> TILE.setOnAlarmEvt(((ObjectProperty<EvtObserver<AlarmEvt>>) property).get());
                case "onTimeEvent"                       -> TILE.setOnTimeEvt(((ObjectProperty<EvtObserver<TimeEvt>>) property).get());
                case "onTileEvent"                       -> TILE.addTileObserver(TileEvt.ANY, ((ObjectProperty<EvtObserver<TileEvt>>) property).get());
                case "alarmsEnabled"                     -> TILE.setAlarmsEnabled(((BooleanProperty) property).get());
                case "alarmsVisible"                     -> TILE.setAlarmsVisible(((BooleanProperty) property).get());
                case "running"                           -> TILE.setRunning(((BooleanProperty) property).get());
                case "increment"                         -> TILE.setIncrement(((DoubleProperty) property).get());
                case "activeColor"                       -> TILE.setActiveColor(((ObjectProperty<Color>) property).get());
                case "duration"                          -> TILE.setDuration(((ObjectProperty<LocalTime>) property).get());
                case "strokeWithGradient"                -> TILE.setStrokeWithGradient(((BooleanProperty) property).get());
                case "fillWithGradient"                  -> TILE.setFillWithGradient(((BooleanProperty) property).get());
                case "image"                             -> TILE.setImage(((ObjectProperty<Image>) property).get());
                case "imageMask"                         -> TILE.setImageMask(((ObjectProperty<ImageMask>) property).get());
                case "graphic"                           -> TILE.setGraphic(((ObjectProperty<Node>) property).get());
                case "svgPath"                           -> TILE.setSVGPath(((ObjectProperty<SVGPath>) property).get());
                case "roundedCorners"                    -> TILE.setRoundedCorners(((BooleanProperty) property).get());
                case "textSize"                          -> TILE.setTextSize(((ObjectProperty<TextSize>) property).get());
                case "currentLocation"                   -> TILE.setCurrentLocation(((ObjectProperty<Location>) property).get());
                case "trackColor"                        -> TILE.setTrackColor(((ObjectProperty<TileColor>) property).get());
                case "mapProvider"                       -> TILE.setMapProvider(((ObjectProperty<MapProvider>) property).get());
                case "tooltipText"                       -> TILE.setTooltipText(((StringProperty) property).get());
                case "xAxis"                             -> TILE.setXAxis(((ObjectProperty<Axis>) property).get());
                case "yAxis"                             -> TILE.setYAxis(((ObjectProperty<Axis>) property).get());
                case "radarChartMode"                    -> TILE.setRadarChartMode(((ObjectProperty<RadarChartMode>) property).get());
                case "chartGridColor"                    -> TILE.setChartGridColor(((ObjectProperty<Color>) property).get());
                case "country"                           -> TILE.setCountry(((ObjectProperty<Country>) property).get());
                case "countryGroup"                      -> TILE.setCountryGroup(((ObjectProperty<BusinessRegion>) property).get());
                case "flipTimeInMS"                      -> TILE.setFlipTimeInMS(((LongProperty) property).get());
                case "flipText"                          -> TILE.setFlipText(((StringProperty) property).get());
                case "itemSorting"                       -> TILE.setItemSorting(((ObjectProperty<ItemSorting>) property).get());
                case "itemSortingTopic"                  -> TILE.setItemSortingTopic(((ObjectProperty<ItemSortingTopic>) property).get());
                case "autoItemTextColor"                 -> TILE.setAutoItemTextColor(((BooleanProperty) property).get());
                case "autoItemDarkTextColor"             -> TILE.setAutoItemDarkTextColor(((ObjectProperty<Color>) property).get());
                case "autoItemBrightTextColor"           -> TILE.setAutoItemBrightTextColor(((ObjectProperty<Color>) property).get());
                case "dataPointsVisible"                 -> TILE.setDataPointsVisible(((BooleanProperty) property).get());
                case "sunburstTree"                      -> TILE.getSunburstChart().setTree(((ObjectProperty<TreeNode>) property).get());
                case "sunburstBackgroundColor"           -> TILE.getSunburstChart().setBackgroundColor(((ObjectProperty<Color>) property).get());
                case "sunburstTextColor"                 -> TILE.getSunburstChart().setTextColor(((ObjectProperty<Color>) property).get());
                case "sunburstUseColorFromParent"        -> TILE.getSunburstChart().setUseColorFromParent(((BooleanProperty) property).get());
                case "sunburstTextOrientation"           -> TILE.getSunburstChart().setTextOrientation(((ObjectProperty<TextOrientation>) property).get());
                case "sunburstVisibleData"               -> TILE.getSunburstChart().setVisibleData(((ObjectProperty<VisibleData>) property).get());
                case "sunburstInteractive"               -> TILE.getSunburstChart().setInteractive(((BooleanProperty) property).get());
                case "sunburstAutoTextColor"             -> TILE.getSunburstChart().setAutoTextColor(((BooleanProperty) property).get());
                case "sunburstUseChartDataTextColor"     -> TILE.getSunburstChart().setUseChartDataTextColor(((BooleanProperty) property).get());
                case "snapToTicks"                       -> TILE.setSnapToTicks(((BooleanProperty) property).get());
                case "minorTickCount"                    -> TILE.setMinorTickCount(((IntegerProperty) property).get());
                case "majorTickUnit"                     -> TILE.setMajorTickUnit(((DoubleProperty) property).get());
                case "matrixSize"                        -> {
                ...
                case "chartType"                         -> TILE.setChartType(((ObjectProperty<ChartType>) property).get());
                case "tooltipTimeout"                    -> TILE.setTooltipTimeout(((DoubleProperty) property).get());
                case "notifyRegionBackgroundColor"       -> TILE.setNotifyRegionBackgroundColor(((ObjectProperty<Color>) property).get());
                case "notifyRegionForegroundColor"       -> TILE.setNotifyRegionForegroundColor(((ObjectProperty<Color>) property).get());
                case "showNotifyRegion"                  -> TILE.showNotifyRegion(((BooleanProperty) property).get());
                case "infoRegionBackgroundColor"         -> TILE.setInfoRegionBackgroundColor(((ObjectProperty<Color>) property).get());
                case "infoRegionForegroundColor"         -> TILE.setInfoRegionForegroundColor(((ObjectProperty<Color>) property).get());
                case "showInfoRegion"                    -> TILE.showInfoRegion(((BooleanProperty) property).get());
                case "lowerRightRegionBackgroundColor"   -> TILE.setLowerRightRegionBackgroundColor(((ObjectProperty<Color>) property).get());
                case "lowerRightRegionForegroundColor"   -> TILE.setLowerRightRegionForegroundColor(((ObjectProperty<Color>) property).get());
                case "lowerRightRegionTooltipText"       -> TILE.setLowerRightRegionTooltipText(((StringProperty) property).get());
                case "showLowerRightRegion"              -> TILE.showLowerRightRegion(((BooleanProperty) property).get());
                case "leftText"                          -> TILE.setLeftText(((StringProperty) property).get());
                case "middleText"                        -> TILE.setMiddleText(((StringProperty) property).get());
                case "rightText"                         -> TILE.setRightText(((StringProperty) property).get());
                case "leftValue"                         -> TILE.setLeftValue(((DoubleProperty) property).get());
                case "middleValue"                       -> TILE.setMiddleValue(((DoubleProperty) property).get());
                case "rightValue"                        -> TILE.setRightValue(((DoubleProperty) property).get());
                case "leftGraphics"                      -> TILE.setLeftGraphics(((ObjectProperty<Node>) property).get());
                case "middleGraphics"                    -> TILE.setMiddleGraphics(((ObjectProperty<Node>) property).get());
                case "rightGraphics"                     -> TILE.setRightGraphics(((ObjectProperty<Node>) property).get());
                case "trendVisible"                      -> TILE.setTrendVisible(((BooleanProperty) property).get());
                case "timeoutMs"                         -> TILE.setTimeoutMs(((LongProperty) property).get());
                case "rank"                              -> TILE.setRank(((ObjectProperty<Rank>) property).get());
                case "interactive"                       -> TILE.setInteractive(((BooleanProperty) property).get());
                case "numberOfValuesForTrendCalculation" -> TILE.setNumberOfValuesForTrendCalculation(((IntegerProperty) property).get());
                case "backgroundImage"                   -> TILE.setBackgroundImage(((ObjectProperty<Image>) property).get());
                case "backgroundImageOpacity"            -> TILE.setBackgroundImageOpacity(((DoubleProperty) property).get());
                case "backgroundImageKeepAspect"         -> TILE.setBackgroundImageKeepAspect(((BooleanProperty) property).get());
                case "infoRegionEventHandler"            -> TILE.setInfoRegionEventHandler(((ObjectProperty<EventHandler<MouseEvent>>) property).get());
                case "infoRegionTooltipText"             -> TILE.setInfoRegionTooltipText(((StringProperty) property).get());
                case "notifyRegionTooltipText"           -> TILE.setNotifyRegionTooltipText(((StringProperty) property).get());
            }
        });
        properties.clear();
        return TILE;
